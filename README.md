...
The only thing changed is how the already voted NFTs gets counted. Originally for each NFT vote a new NFT vote record was created which required to create a new account. Once the voting was done, this account can be disposed and recollect the rent from these NFTVoteRecords, with a second interaction.

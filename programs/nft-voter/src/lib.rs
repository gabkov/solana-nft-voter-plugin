...
declare_id!("GhkybELahfQMR2Afvk5WGm497ehokZ5EPA6Y2uKkpsmw");
...
pub mod nft_voter {
    ...
    pub fn relinquish_nft_vote(ctx: Context<RelinquishNftVote>, collection: Pubkey) -> Result<()> {
        log_version();
        instructions::relinquish_nft_vote(ctx, collection)
    }
